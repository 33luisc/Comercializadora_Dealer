...
import ModalDetalleBonificacion from './ModalDetalleBonificacion';
...
function DashboardControls({ 
  ...
  // Determinar la lista de usuarios adecuada según el modo (Histórico o Mes Activo)
  const listaUsuariosParaModal = verHistorico ? datosHistoricos : afiliados;
    ...
    <>
      <div style={{ width: '100%', fontFamily: 'sans-serif', marginBottom: '16px' }}>
        ...
        <div style={{ 
          ...
          {/* Tarjeta 3: Bonificaciones Interactiva */}
          <button
            type="button"
            onClick={() => setModalBonificacionData(listaUsuariosParaModal)}
            title="Ver desglose de bonificaciones por usuario"
            style={{
              width: '100%',
              textAlign: 'left',
